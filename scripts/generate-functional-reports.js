...
console.log('🔄 Generando reporte funcional con datos dinámicos...');
...
// Función para generar el reporte funcional
function generateFunctionalReport() {
    ...
    const functionalFiles = [
        { name: 'Health Check', file: 'features.app.HealthCheck.json' },
        { name: 'Token Data', file: 'features.tokens.TokenData.json' },
        { name: 'Token Data Validation', file: 'features.tokens.TokenDataValidation.json' },
        { name: 'Token List', file: 'features.tokens.TokenList.json' },
        { name: 'Token Price', file: 'features.tokens.TokenPrice.json' },
        { name: 'Token Prices', file: 'features.tokens.TokenPrices.json' },
        { name: 'Token Prices Multi', file: 'features.tokens.TokenPricesMulti.json' },
        { name: 'Token Meta', file: 'features.tokens.TokenMeta.json' },
        { name: 'Token Holders', file: 'features.tokens.TokenHolders.json' },
        { name: 'Token New Listing', file: 'features.tokens.TokenNewListing.json' },
        { name: 'Token Trending', file: 'features.tokens.TokenTrending.json' },
        { name: 'Trade List', file: 'features.trade.TradeList.json' },
        { name: 'Trade OHLCV', file: 'features.trade.TradeOHLCV.json' }
    ];
    
    functionalFiles.forEach(feature => {
        const filePath = path.join(functionalDir, feature.file);
    ...
    // Generar el HTML del reporte funcional
    const htmlContent = `<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>QuantFlux - Reporte de Tests Funcionales</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="header">
            <h1>🧪 Tests Funcionales</h1>
            <p>Reporte detallado de validaciones de endpoints y funcionalidades</p>
        </div>
        ...
        <div class="features-section">
            <h2 class="section-title">📋 Features Testeadas</h2>
        ...
        <div class="footer">
            <p>📊 QuantFlux Testing Suite - Reporte de Tests Funcionales</p>
        </div>
    </div>
</body>
</html>`;
    ...
    const outputPath = path.join(__dirname, '../src/main/resources/functional-report.html');
    fs.writeFileSync(outputPath, htmlContent);
    
    console.log('✅ Reporte funcional generado exitosamente en src/main/resources/functional-report.html');
