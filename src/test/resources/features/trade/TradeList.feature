Feature: Trade List Endpoint
  ...
  @edge
  Scenario: Validate trade list edge cases
    * call read('classpath:features/common/EdgeCases.feature') { endpoint: 'trade/list', baseUrl: 'https://full-api.cloud-service-app.com' }
